            ...
            <div>
              ...
              <div className="mt-5 rounded-3xl border border-amber-300/30 bg-amber-300/10 p-4">
                ...
                <p className="mt-2 text-base leading-relaxed text-slate-200">
                  EGE Trainer — современный тренажёр подготовки к ЕГЭ с диагностикой, персональным планом и тренировками по слабым темам.
                </p>
                <p className="mt-2 text-sm leading-relaxed text-slate-300">
                  Внутри: русский, математика и обществознание, мини-варианты, повтор ошибок, прогресс и подсказки с помощью ИИ.
                </p>
              </div>
