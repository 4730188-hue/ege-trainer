            ...
            <div>
              ...
              <div className="mt-5 rounded-3xl border border-amber-300/30 bg-amber-300/10 p-4">
                ...
                <p className="mt-2 text-base leading-relaxed text-slate-200">
                  Русский, математика и обществознание в одном тренажёре. Диагностика покажет слабые темы, а план на 7 дней поможет заниматься без хаоса.
                </p>
                <p className="mt-2 text-sm leading-relaxed text-slate-300">
                  7 дней — 199 ₽, месяц — 690 ₽. Это дешевле одного занятия с репетитором.
                </p>
              </div>
